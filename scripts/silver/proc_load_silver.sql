...
--Şimdi bunu silver katmana yükleme yapan bir procedure dönüştürelim
...
BEGIN
	...
	--Loading silver.crm_prd_info
		SET @start_time = GETDATE();
	--Şimdi düzenlemesi tamamlanan bronze.crm_prd_info tablosunu silver katmana yükleyelim
	...
	SET @start_time = GETDATE();
	--Şimdi düzenlemesi tamamlanan bronze.crm_sales_details tablosunu silver katmana yükleyelim
	...
	SET @start_time = GETDATE();
	--Şimdi düzenlemesi tamamlanan bronze.erp_cust_az12 tablosunu silver katmana yükleyelim
	...
	SET @start_time = GETDATE();
	--Şimdi düzenlemesi tamamlanan bronze.erp_loc_a101 tablosunu silver katmana yükleyelim
	...
	SET @start_time = GETDATE();
	--Şimdi düzenlemesi tamamlanan bronze.erp_px_cat_g1v2 tablosunu silver katmana yükleyelim
